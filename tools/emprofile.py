...
def create_profiling_graph(outfile):
  ...
  template_file = os.path.join(script_dir, 'toolchain_profiler.results_template.html')
  with open(template_file) as f:
    html_contents = f.read()
  html_contents = html_contents.replace('{{{ emprofile_json_data }}}', emprofile_json_data)
